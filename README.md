...
* **🖼️ Cover Image Support:** Upload and display cover images for each book directly within the application grid.
...
* **🛠️ Data Integrity:** Includes tools to recalculate statistics for the entire library to ensure data accuracy.
